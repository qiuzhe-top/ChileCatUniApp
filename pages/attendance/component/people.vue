...
<template>
	<view class="people-box">
		<PeopleList @to_people="to_people" :is_position_mode="true"
		:init_people_store='init_people_store' ref="people_list_vue" ></PeopleList>
...
export default {
	...
	methods:{
		rule(){
			this.$store.dispatch('school_attendance_rule', {  codename: this.$props.rule_codename_store }).then(res=>{
